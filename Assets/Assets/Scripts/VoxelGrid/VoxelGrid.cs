    ...
    public Dictionary<int, GameObject> GOPatternPrefabs
    {
        get
        {
            if (_goPatternPrefabs == null)
            {
                ...
                _goPatternPrefabs = new Dictionary<int, GameObject>();
                _goPatternPrefabs.Add(0, Resources.Load("Prefabs/UShap") as GameObject);
                _goPatternPrefabs.Add(1, Resources.Load("Prefabs/HShape") as GameObject);
                _goPatternPrefabs.Add(2, Resources.Load("Prefabs/OShape") as GameObject);
                _goPatternPrefabs.Add(3, Resources.Load("Prefabs/SShape") as GameObject);
                _goPatternPrefabs.Add(4, Resources.Load("Prefabs/HookShape") as GameObject);
                _goPatternPrefabs.Add(4, Resources.Load("Prefabs/6Shape") as GameObject);
                _goPatternPrefabs.Add(5, Resources.Load("Prefabs/LongHookShape") as GameObject);
                _goPatternPrefabs.Add(6, Resources.Load("Prefabs/LongHShape") as GameObject);
            }
